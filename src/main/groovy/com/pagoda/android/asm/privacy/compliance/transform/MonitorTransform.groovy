package com.pagoda.android.asm.privacy.compliance.transform
...
class MonitorTransform extends Transform {
    ...
    private ComplianceConfig monitorConfig

    MonitorTransform(Project project) {
        this.project = project
    }

    void setMonitorConfig(ComplianceConfig monitorConfig) {
    ...
    Set<? super QualifiedContent.Scope> getScopes() {
        return ImmutableSet.of(QualifiedContent.Scope.PROJECT,          // 库项目内部的代码
//                QualifiedContent.Scope.RESOURCES,        // 库项目中的资源文件
                QualifiedContent.Scope.EXTERNAL_LIBRARIES // 依赖的外部三方库
        )
    }
    /**
     * 是否增量编译
    ...
    void transform(TransformInvocation transformInvocation) throws TransformException, InterruptedException, IOException {
        ...
        if (monitorConfig.disablePlugin) {
            return
        }
    ...
    void handleDirectoryInput(Context context, DirectoryInput directoryInput, TransformOutputProvider outputProvider, ComplianceConfig monitorConfig, boolean isIncremental) {
    ...
    void handleJarInput(Context context, JarInput jarInput, TransformOutputProvider outputProvider, ComplianceConfig monitorConfig, boolean isIncremental) {
        //获得输出文件
    ...
    void transformJar(Context context, JarInput jarInput, TransformOutputProvider outputProvider, ComplianceConfig monitorConfig1) {
